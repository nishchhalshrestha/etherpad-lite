...
/*var byteString;
    ...
    var imgBlob = new Blob([ia], {type:mimeString});
    var shirtDesignFormData = new FormData();
                    shirtDesignFormData.append("img", imgBlob);*/

          $.ajax({
            url: 'http://hi-map.org/stage/api/upload_ether_image',
            data: {img: dataURI},
            //processData: false,
            //contentType: false,
            //datatype: 'json',
